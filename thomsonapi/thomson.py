...
class Thomson:
    ...
    def parse_license_xml_object(self, license_obj):
        ...
        NbOfUsedLicenceDec = license_obj.attributes[
            'NbOfUsedLicenceDec'].value if "'NbOfUsedLicenceDec'" in str_license_obj else ''
        NbOfUsedLicence = license_obj.attributes[
            'NbOfUsedLicence'].value if "'NbOfUsedLicence'" in str_license_obj else ''
    ...
    def parse_license(self, license_xml):
        ...
        for license_obj in itemlist:
            Nb, Name, NbOfUsedLicenceDec, NbOfUsedLicence, Desc = self.parse_license_xml_object(
                license_obj)
